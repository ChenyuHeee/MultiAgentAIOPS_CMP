...
Action Tool Input: the input to the action tool.
    - Prefer a JSON object with keys matching parameter names, e.g. {{"endpoint": "...", "minute": "YYYY-MM-DD HH:MM"}}
    - You may also use key=value pairs, but string values MUST be quoted if possible.
...
class DependencyExplorer(AgentWorkflow):
    def __init__(self) -> None:
        ...
        # NOTE: upstream project uses a misspelled filename: denpendency_explorer_tools.py
        self.tool_path = "agents/tools/denpendency_explorer_tools.py"
