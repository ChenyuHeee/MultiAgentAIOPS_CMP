...
def get_endpoint_downstream(endpoint: str, minute: str | None = None) -> list:
    """
    ...
    return traceExplorer.get_endpoint_downstream(endpoint, minute)
...
def get_endpoint_upstream(endpoint: str, minute: str | None = None) -> list:
    """
    ...
    """
    traceExplorer = TraceExplorer()
    return traceExplorer.get_endpoint_upstream(endpoint, minute)

def get_call_chain_for_endpoint(endpoint: str, minute: str | None = None) -> dict:
    """
    ...
    """
    traceExplorer = TraceExplorer()
    return traceExplorer.get_call_chain_for_endpoint(endpoint, minute)
